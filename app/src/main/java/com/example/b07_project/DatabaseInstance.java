    ...
    public static Database get_instance() {
        if (db == null) {
            ...
            db.add_event(v1,"tennis", "play tennis",
                    2, new TimeSlot(1), 20);
            db.add_event(v1,"tennis alejandro", "play tennis w/ alejandro", 1, new TimeSlot(1), 20);
            db.add_event(v1, "random guy concert",
                    "concert of a random guy", 3, new TimeSlot(1), 20);
            db.add_event(v2, "weed smoking contest",
                    "smoke week and have fun", 4, new TimeSlot(1), 20);
            db.add_event(v2, "swallow kids event",
                    "swallow kids and try not to choke", 5, new TimeSlot(1), 20);
        }
        return db;
    }
